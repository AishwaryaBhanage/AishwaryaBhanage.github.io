// Brand marks — lucide-react dropped these, so they live here as inline SVG.
// Same props shape as lucide icons (size, plus anything spread onto <svg>).
...
export function Linkedin({ size = 16, ...props }) {
  return (
    <svg
      width={size} height={size} viewBox="0 0 24 24" fill="currentColor"
      aria-hidden="true" focusable="false" {...props}
